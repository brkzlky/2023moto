	...
	function z(t, f, o) {
					...
					!(function (t, e, r) {
						if ((r = i ? i(e, r) : r) !== N) {
							...
							(n.className = p(r, f.cssClasses.marker)),
								(n.style[f.style] = t + '%'),
								U < r && (((n = M(a, !1)).className = p(r, f.cssClasses.value)), n.setAttribute('data-value', e), (n.style[f.style] = t + '%'), (n.innerHTML = o.to(e)));
						}
					})(t, e[t][0], e[t][1]);
				}),
				a
		...
		function q(t, e) {
			...
			i.push.apply(i, o.concat(a, s)),
				t.cursor && ((C.style.cursor = getComputedStyle(t.target).cursor), 1 < u.length && at(y, f.cssClasses.drag), C.addEventListener('selectstart', rt, !1)),
				e.handleNumbers.forEach(function (t) {
					Y('start', t);
				});
		}
			...
			(e = void 0 === e || !!e),
				...
				g.forEach(function (t) {
					...
					K(
						...
						((e = n[t]),
						(r = t),
						null === e || !1 === e || void 0 === e ? m[r] : ('number' == typeof e && (e = String(e)), (e = f.format.from(e)), !1 === (e = E.toStepping(e)) || isNaN(e) ? m[r] : e)),
						!0,
						!1
					);
				}),
