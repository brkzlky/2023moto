<!--begin::Header-->
<form action="{{ route('admin.users.detail',$user->user_guid) }}" method="GET" enctype="multipart/form-data">
        ...
        <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="text-dark-75 d-block font-size-lg"><a
                                href="{{ route('admin.users.detail',$listing->user->user_guid) }}" target="_blank">{{
                                $listing->user->name }}</a>
                        </span>
                    </td>
                    </td>
                    ...
                    <td>
                        ...
                        <button guid="{{ $listing->listing_guid }}" cname="{{ $listing->name_en }}" data-toggle="modal"
...
<div class="modal fade" id="delete_listings_modal" data-backdrop="static" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-content" role="document">
        ...
        <form class="w-100" method="post" action="{{ route('admin.users.delete_listing') }}">
            @csrf
            <div class="modal-footer">
                <input type="hidden" name="listing_guid" id="delete_guide" value="" required />
                <input type="hidden" name="user_guid" value="{{ $user->user_guid }}" required />
